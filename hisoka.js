...
let teks = `══✪〘 *👥 Tag All* 〙✪══
 ...
 ➲ *Pesan : ${q ? q : 'kosong'}*\n\n`
            ...
            hisoka.sendMessage(m.chat, { text : quoted.text , mentions: participants.map(a => a.id), contextInfo: { forwardingScore: 5, isForwarded: true } }, { quoted: m })
            } else {
                ...
                _pesan.message = _msg
                hisoka.copyNForward(m.chat, _pesan, true)
              }
            }
            break
...
`
                let btn = [{
                                urlButton: {
                                    displayText: 'Source Code',
                                    url: 'https://net-pedia.site/'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Phone',
                                    phoneNumber: '+62 851-5675-6860'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Network',
                        ...
                        hisoka.send5ButImg(m.chat, anu, 'Net Digital ~ Multi Device', global.thumb, btn)
                     }
            break
            default:
                if (budy.startsWith('=>')) {
